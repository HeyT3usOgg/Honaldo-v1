...
Chatbot criado por zueira, ele não é um assiste virtual para facilitar sua vida ou algo do tipo. Foi criado para responder frases pre-programadas parar interagir e soltar sons e também foi criado como forma de estudo usando python e customtkinter.
